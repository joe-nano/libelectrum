...
BCW_API std::string secret_to_wif(
    const bc::ec_secret& secret, bool compressed=true);
 ...
 * @endcode
 */
BCW_API bc::ec_secret wif_to_secret(const std::string& wif);
 ...
 * @endcode
 */
BCW_API bc::ec_secret minikey_to_secret(const std::string& minikey);
